...
//			if ((difficult === 'university' || (difficult === 'school' && remItVars.curLevel >= 4)) && Math.random() < 0.8) {
	...
	function run() {
		...
		setBodySize();
//		console.log('setBodySize()');
		setWorkSpaceSize();
//		console.log('setWorkSpaceSize()');
		setFigureContainerSize();
//		console.log('setFigureContainerSize()');
		showSplashScreen();
...
//		console.log('addSwipe()');
		setBadAnswer();
//		console.log('setBadAnswer()');
		setGoodAnswer();
//		console.log('setGoodAnswer()');
		setWinFormButton();
//		console.log('setWinFormButton()');
		setFailFormButton();
		console.log('remember it - run');
	}
