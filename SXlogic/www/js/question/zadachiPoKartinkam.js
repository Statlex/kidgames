	...
	win.sections.zadachiPoKartinkam = {
		...
		questions: [
			...
			},
			{
				...
				image: 'http://www.smekalka.pp.ru/sites/default/files/1715.gif',
				text: 'Какая из шести черных фигур в точности соответствует красной?',
				hint: '',
				answer: 'B, D и E'
			},
			{
				title: 'Задача на пространственное воображение-5',
				image: 'http://www.smekalka.pp.ru/sites/default/files/1718.gif',
				text: 'Какая из семи черных фигур в точности соответствует красной?',
				hint: '',
				answer: 'A, E и F'
			...
			},
			{
				...
				image: 'http://www.smekalka.pp.ru/sites/default/files/1726.gif',
				text: 'Развертка какого кубика приведена слева?',
				hint: '',
				answer: 'B'
			...
			},
			{
				...
				image: 'http://www.smekalka.pp.ru/sites/default/files/1732.gif',
				text: 'Развертка какого кубика приведена слева?',
				hint: '',
				answer: 'E и F'
			...
			},
			{
				...
				image: 'http://www.smekalka.pp.ru/sites/default/files/1737.gif',
				text: 'Развертка какого кубика приведена слева?',
				hint: '',
				answer: 'A'
			...
			},
			{
				...
				image: 'http://www.smekalka.pp.ru/sites/default/files/1750_1.gif',
				text: 'Есть четыре изображения одного кубика с разных сторон. Необходимо правильно нарисовать его развертку',
				hint: '',
			...
			{
				title: 'Шестеренки',
				image: 'http://www.smekalka.pp.ru/sites/default/files/1773.png',
				text: 'На плоскости расположено 11 шестерёнок, соединённых по цепочке:',
				hint: '',
				answer: 'Предположим, что первая шестерёнка вращается по часовой стрелке. Тогда вторая шестерёнка должна вращаться против часовой стрелки. Третья — снова по часовой, четвёртая — против и т.д. Ясно, что «нечётные» шестерёнки должны вращаться по часовой стрелке, а «чётные» — против. Но тогда первая и одиннадцатая шестерёнки одновременно вращаются по часовой стрелке, что невозможно'

			},
			{
				title: 'Вычислить вес детали',
				image: 'http://www.smekalka.pp.ru/sites/default/files/1793.jpg',
				text: 'Из заготовки, имевшей форму правильного куба, была сделана деталь, показанная на рисунке. Не удастся ли вам вычислить, сколько весит деталь, если заготовка весила 250 граммов? Шесть отверстий на поверхностях детали — сквозные. Деталь симметрична, т.е. задняя (невидимая) часть выглядит аналогично передней',
				hint: '',
				answer: '178 грамм'
			...
			{
				title: 'Лишняя фигура',
				image: 'http://www.smekalka.pp.ru/sites/default/files/1826.jpg',
				text: 'Какая фигура здесь лишняя?',
				hint: '',
			...
			{
				title: 'Квадраты',
				image: 'http://www.smekalka.pp.ru/sites/default/files/1850.jpg',
				text: 'Найдите квадраты, которые не зацеплены ни с какими другими?<br>P. S. Знающие хоть немного английский язык могут в качестве подсказки прочитать, сколько квадратов нужно искать))',
				hint: '',
			...
			},
			{
				...
				image: 'http://www.smekalka.pp.ru/sites/default/files/1857.jpg',
				text: 'Сколько карандашей на этой фотографии?',
				hint: '',
				answer: '72 (18*4)'
			...
			},
			{
				...
				image: 'http://www.smekalka.pp.ru/sites/default/files/1863.jpg',
				text: 'Сосчитайте, сколько квадратов на этом рисунке?',
				hint: '',
			...
			{
				title: 'Шесть кругов',
				image: 'http://www.smekalka.pp.ru/sites/default/files/1865.jpg',
				text: '6 кругов разделены на части. Вам дается полминуты на то, чтобы решить, какие два круга разделены на наибольшее число частей. Если начать заниматься подсчетами, Вы не уложитесь в отведенное время. Единственный выход – оценивать на глаз',
				hint: '',
