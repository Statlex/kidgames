		...
		questions: [
			{
				...
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%90%D1%80%D0%B8%D1%84%D0%BC%D0%B5%D1%82%D0%B8%D0%BA%D0%B0.png_!_Нужно переместить только одну спичку в выложенном спичками арифметическом примере «8+3-4=0» так, чтобы получилось верное равенство (можно менять и знаки, цифры) ',
				hint: '',
				answer: 'Эта классическая математическая спичечная головоломка решается несколькими способами. Как вы уже догадались спички нужно перемещать так, чтобы получились другие цифры.<br>Первый способ. Из восьмерки перемещаем нижнюю левую спичку в середину нуля. Получается: 9+3-4=8.<br>Второй способ. От цифры 8 убираем правую верхнюю спичку и ставим ее на верх четверки. В итоге верное равенство: 6+3-9=0.<br>Третий способ. В цифре 4 переворачиваем горизонтальную спичку вертикально и перемещаем ее в нижний левый угол четверки. И опять арифметическое выражение верно: 8+3-11=0.<br>Существуют и другие креативные способы решения этого примера по математике, например, с модификацией знака равно 0+3-4 ≠ 0, 8+3-4 > 0, но это уже нарушает условие_!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%90%D1%80%D0%B8%D1%84%D0%BC%D0%B5%D1%82%D0%B8%D0%BA%D0%B0-%D0%9E%D0%A2%D0%92%D0%95%D0%A2.png '

			},
			{
				title: 'Развернуть рыбку',
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/%D1%80%D1%8B%D0%B1%D0%BA%D0%B0.png_!_Переставьте три спички так, чтобы рыбка поплыла в обратном направлении. Другими словами, нужно повернуть рыбу на 180 градусов по горизонтали',
				hint: '',
				answer: 'Для решения задачи будем передвигать спички, которые составляют нижнюю часть хвоста и туловища, а также нижний плавник нашей рыбы. Переместим 2 спички наверх, а одну вправо, как показано на схеме. Теперь рыбка плывет не вправо, а влево._!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D1%80%D1%8B%D0%B1%D0%BA%D0%B0-%D0%BE%D1%82%D0%B2%D0%B5%D1%82.png'

			},
			{
				title: 'Подобрать ключ',
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%9A%D0%BB%D1%8E%D1%87.png_!_В этой задаче из 10 спичек сложена форма ключа. Передвиньте 4 спички так, чтобы получилось три квадрата',
				hint: '',
				answer: 'Задача решается достаточно просто. Четыре спички, образующие ту часть ручку ключа, нужно переместить на стержень ключа, так чтобы 3 квадрата были выложены в ряд_!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%BE%D1%82%D0%B2%D0%B5%D1%82-%D0%BD%D0%B0-%D0%BA%D0%BB%D1%8E%D1%87.png'

			},
			{
				title: 'Поле для крестиков-ноликов',
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%9A%D1%80%D0%B5%D1%81%D1%82%D0%B8%D0%BA%D0%B8-%D0%BD%D0%BE%D0%BB%D0%B8%D0%BA%D0%B8.png_!_Необходимо переложить 3 спички так, чтобы получить ровно 3 квадрата',
				hint: '',
				answer: ' Чтобы получить ровно три квадрата в этой задаче необходимо переместить 2 нижних вертикальных спички вправо и влево соответственно, чтобы они замыкали боковые квадраты. А нижней центральной горизонтальной спичкой нужно замкнуть верхний квадрат_!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%9A%D1%80%D0%B5%D1%81%D1%82%D0%B8%D0%BA%D0%B8-%D0%9E%D0%A2%D0%92%D0%95%D0%A2.png'

			},
			{
				title: 'Головоломка «бокал с вишенкой»',
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%92%D0%B8%D1%88%D0%BD%D1%8F.png_!_С помощью четырех спичек сложена форма бокала, внутри которого лежит вишня. Нужно передвинуть две спички так, чтобы вишня оказалась за пределами бокала. Разрешается менять положение бокала в пространстве, однако его форма должна оставаться неизменной',
				hint: '',
				answer: 'Решение этой достаточно известной логической задачи с 4 спичками основывается на том, что мы меняем положение бокала, переворачивая его. Самая левая спичка уходит вправо вниз, а горизонтальная – перемещается правее на половину своей длины._!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%92%D0%B8%D1%88%D0%BD%D1%8F-%D0%9E%D0%A2%D0%92%D0%95%D0%A2.png'

			},
			{
				title: 'Оставить два квадрата',
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/9-%D0%BA%D0%B2%D0%B0%D0%B4%D1%80%D0%B0%D1%82%D0%BE%D0%B2.png_!_Перед Вами девять маленьких квадратов, образованных двадцатью четырьмя спичками. Уберите 8 спичек, не трогая остальных, чтобы осталось всего лишь 2 квадрата',
				hint: '',
				answer: 'Ответ. Для этой задачи я нашел 2 способа решения.<br>Первый способ. Убрать спички так, чтобы остался только самый большой квадрат, образованный крайними спичками и самый маленький квадрат в центре, состоящий из четырех спичек.<br>Второй способ. Также оставить самый большой квадрат из 12 спичек, а также квадрат 2 на 2 спички. У последнего квадрата 2 стороны должны образовываться спичками большой квадрата, а 2 другие стороны должны быть в центре._!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%A0%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D0%B5-1.png_!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%A0%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D0%B5-2.png'

			},
			{
				title: 'Соприкасающиеся друг с другом спички',
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/6-%D1%81%D0%BF%D0%B8%D1%87%D0%B5%D0%BA.png_!_Необходимо разместить 6 спичек так, чтобы каждая спичка соприкасалась с остальными пятью',
				hint: '',
				answer: 'Это задание требует подключения ваших творческих способностей, и выход за рамки плоскости – ведь спички можно класть друг на друга. Верное решение выглядит следующим образом. На схеме все спички действительно соприкасаются друг с другом. Хочу отметить, онлайн нарисовать такую фигуры гораздо проще, чем выложить так настоящие спички_!_http://4brain.ru/blog/wp-content/uploads/2013/09/6-%D1%81%D0%BF%D0%B8%D1%87%D0%B5%D0%BA-%D0%9E%D0%A2%D0%92%D0%95%D0%A2.png'

			},
			{
				title: 'Семь квадратов',
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%9A%D0%B2%D0%B0%D0%B4%D1%80%D0%B0%D1%82-4.png_!_Переложите 2 спички так, чтобы образовать 7 квадратов',
				hint: '',
				answer: 'Чтобы решить эту достаточно сложную задачу нужно думать нешаблонно. Берем 2 любые спички, образующие угол самого большого внешнего квадрата и кладем их крест-накрест друг на друга в один из маленьких квадратов. Так мы получаем 3 квадрата 1 на 1 спичку и 4 квадрата со сторонами длиной в половину спички_!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%9E%D1%82%D0%B2%D0%B5%D1%82-7-%D0%BA%D0%B2%D0%B0%D0%B4%D1%80%D0%B0%D1%82%D0%BE%D0%B2.png'

			},
			{
				title: 'Оставить 1 треугольник',
				image: '',
				text: 'http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%94%D0%BE%D0%BC%D0%B8%D0%BA.png_!_Передвиньте 1 спичку так, чтобы вместо 9 треугольников остался только один',
				hint: '',
				answer: 'Эта головоломка не разгадывается стандартным способом. Для решения поставленной задачи нужно немного исхитриться (снова использовать свое креативное мышление). Нам нужно избавиться от креста в середине. Берем нижнюю спичку креста, так чтобы она подняла и верхнюю одновременно. Поворачиваем крест на 45 градусов, так чтобы он образовывал в центре домика не треугольники, а квадраты._!_Стоит отметить, что за экраном компьютера онлайн эту задачу решить очень трудно. А вот если взять реальные спички, то головоломка разгадывается гораздо проще._!_http://4brain.ru/blog/wp-content/uploads/2013/09/%D0%94%D0%BE%D0%BC%D0%B8%D0%BA-%D0%BE%D1%82%D0%B2%D0%B5%D1%82-.png'
