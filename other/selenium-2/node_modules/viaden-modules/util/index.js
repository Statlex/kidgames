(function () {
	...
	util = {
		...
		getCardNumber: function (numberLength) {
			...
			numberLength = (numberLength || 13) - 1;
			...
			function getCardNumber() {
				...
				var controlNumber = parseInt( controlSum[controlSum.length - 1] );
		...
		scrollTo: function(driver, selector) {
			driver.executeScript("document.querySelector('" + selector + "').scrollIntoView(true); window.scrollBy(0, 200);");
		},
