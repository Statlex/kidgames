(function () {
	...
	selector = {
		...
		modalClose: 'body .modal.overlay:last-child .alert-close',

		openFooter: '[href="#footer"]',
		closeFooter: '#contextAmount',
		footerLinks: ['.main-nav a[href="/promotions"]', '.main-nav a[href="/gaming/all"]', '.main-nav a[href="/"]'],
