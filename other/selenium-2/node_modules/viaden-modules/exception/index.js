(function () {
	...
	var exception, mainCfg, util, path, webDriver, fs;
	...
	exception = {
		...
		startListener: function () {
			...
			webDriver.promise.controlFlow().on('uncaughtException', this.save.bind(this));
		...
		save: function (e) {
			...
			fs.writeFile(pathToReport, log, function(err) {
				if(err) {
					...
					console.log("The EXCEPTION was saved in " + pathToReport);
				}
			});
